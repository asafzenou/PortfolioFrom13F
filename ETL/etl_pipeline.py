...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source",
        required=True,
        choices=["csv", "xml", "sec-zip"],
        help="Data source type: csv | xml | sec-zip (SEC 13F ZIP dataset)",
    )
    ...
    # SEC ZIP arguments
    parser.add_argument("--url", help="SEC 13F dataset ZIP URL (required for sec-zip)")
